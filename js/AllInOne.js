...
window.Widget = class{
    ...
    render(){
        ...
        const credits = document.createElement('widget-credits');
        credits.innerHTML = 'Widget sviluppato da <a href="https://phi.it" target="_blank">PHI Informatica</a>';

        this.#container.popup.appendChild(credits);
